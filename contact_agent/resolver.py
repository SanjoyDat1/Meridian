...
3. Provide a **critical_thinking** block: reason explicitly about trade-offs,
   procedural risk, and what counsel should verify before sending outreach.
...
Return ONLY valid JSON with no preamble or markdown fences matching this schema:
{
  ...
  "critical_thinking": {
    "outreach_rationale": "<why outreach vs wait>",
    "information_gaps": ["<gap>"],
    "risk_notes": ["<procedural or documentation risk>"],
    "recommended_actions_for_counsel": ["<action>"]
  },
  "email_draft": {
