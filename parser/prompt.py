...
Critical thinking:
- Extract only what the document supports; lower confidence and add high-importance missing_fields when facts are ambiguous or internally inconsistent.
- When appeal deadlines or rationales are vague, reflect that in missing_info_request rather than guessing.
"""
